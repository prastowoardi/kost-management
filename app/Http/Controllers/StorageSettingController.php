...
class StorageSettingController extends Controller
{
    ...
    public function switch(Request $request)
    {
        try {
            ...
            LogHelper::logError('SWITCH_STORAGE_FAILED', 'Gagal mengganti penyimpanan', $e);

            return back()->with('error', 'Gagal mengganti penyimpanan.');
        }
    }
        ...
        try {
            ...
            for ($i = 0; $i < $batch; $i++) {
                ...
                try {
                    ...
                    $failed++;
                    LogHelper::logError(
                        'MIGRATE_STORAGE_FILE_FAILED',
                        "Gagal migrasi file: {$file}",
                        $e
                    );
                }
            ...
            LogHelper::logError('MIGRATE_STORAGE_FAILED', 'Gagal proses migrasi', $e);

            return response()->json(['error' => 'Gagal memproses migrasi.'], 500);
        }
    }
