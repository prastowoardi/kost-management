...
<div {{ $attributes->only('class') }}>
    ...
    <input
        ...
        class="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:ring-2 focus:ring-slate-300 focus:border-slate-400 outline-none transition cursor-pointer"
    >
</div>
