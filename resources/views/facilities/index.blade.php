                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center gap-1">
                                            ...
                                            <button onclick="confirmDelete(event, 'delete-facility-{{ $facility->id }}', 'Fasilitas {{ $facility->name }}')" class="p-1.5 text-stone-400 transition hover:text-red-600" title="Hapus Fasilitas">
