                    ...
                    <form action="{{ route('facilities.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="form-group">
                                ...
                                <select id="condition" name="condition" required class="mt-1 block w-full rounded-xl border-stone-200 shadow-sm focus:border-brand-500 focus:ring-brand-500">
                            ...
                            <div class="form-group md:col-span-2">
                                ...
                                <textarea id="description" name="description" rows="3"
                                    class="mt-1 block w-full rounded-xl border-stone-200 shadow-sm focus:border-brand-500 focus:ring-brand-500"
                                    placeholder="Deskripsi detail fasilitas">{{ old('description') }}</textarea>
                                @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
