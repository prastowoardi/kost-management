                    ...
                    <form action="{{ route('tenants.update', $tenant) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="emergency_contact" rows="2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Nama & No. Telepon Keluarga">{{ old('emergency_contact', $tenant->emergency_contact) }}</textarea>
