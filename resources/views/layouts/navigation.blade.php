...
<!-- Sidebar -->
<aside
    class="sidebar-scroll fixed inset-y-0 left-0 z-50 flex w-[var(--sidebar-w,288px)] max-w-[85vw] flex-col overflow-y-auto border-r border-stone-200/70 bg-white shadow-lift transition-transform duration-300 ease-in-out lg:sticky lg:top-0 lg:z-30 lg:h-screen lg:translate-x-0 lg:shadow-none"
