                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center gap-1">
                                            ...
                                            <button onclick="confirmDelete(event, 'delete-room-{{ $room->id }}', 'Kamar {{ $room->room_number }}')" class="p-1.5 text-stone-400 transition hover:text-red-600" title="Hapus Kamar">
